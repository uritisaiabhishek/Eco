<?php 
	...
	if ( !current_user_can( 'administrator' )  && !is_admin() && (display_user_role() != 'company_profile') && (display_user_role() != 'company_hr')) {
		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header d-flex align-items-center justify-content-between">
					<h5 class="text-center m-0">Testimonials</h5>
				</div>
				<div class="card-body">
					<?php
						// Query the posts
						$args = array(
							'post_type'      => 'testimonial',        // Change to your desired post type
